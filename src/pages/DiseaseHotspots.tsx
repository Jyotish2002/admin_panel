      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
        ...
        <div className="lg:col-span-2">
          <div className="card p-4 lg:p-6 h-96">
            ...
            <div className="bg-gray-100 dark:bg-gray-700 rounded-lg h-80 flex items-center justify-center relative overflow-hidden">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-500 mt-1">Disease hotspots marked by severity</p>
              </div>
